        ...
        methods:
                {
                    ...
                    addNewAreaOfInterest()
                    {
                        ...
                        axios.post('http://arcx-development-admin-api.devsecops-eval.epa.gov/api/area_of_interest',
                    ...
                    getAreaOfInterest()
                    {
                        ...
                        jQuery.getJSON('http://arcx-development-admin-api.devsecops-eval.epa.gov/api/area_of_interest', function (areaofint) {
